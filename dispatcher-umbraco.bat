...
echo Reverting umbraco directories...
XCOPY %HostingDirectory%-old-%d%-%t%\App_Data %HostingDirectory%\App_Data\ /E /F /O /R /Y
XCOPY %HostingDirectory%-old-%d%-%t%\bin %HostingDirectory%\bin\ /D /S /Y /O
XCOPY %HostingDirectory%-old-%d%-%t%\umbraco %HostingDirectory%\umbraco\ /D /S /Y /O
XCOPY %HostingDirectory%-old-%d%-%t%\media %HostingDirectory%\media\ /D /S /Y /O
XCOPY %HostingDirectory%-old-%d%-%t%\umbraco_client %HostingDirectory%\umbraco_client\ /D /S /Y /O
XCOPY %HostingDirectory%-old-%d%-%t%\usercontrols %HostingDirectory%\usercontrols\ /D /S /Y /O
